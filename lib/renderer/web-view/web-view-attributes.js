...
class SrcAttribute extends WebViewAttribute {
  ...
  parse () {
    ...
    let command = 'ELECTRON_BROWSER_SYNC_CALL_TO_GUEST_VIEW'
    const [error] = ipcRenderer.sendSync(command, this.webViewImpl.guestInstanceId, 'loadURL', this.getValue(), opts)
    if (error) {
